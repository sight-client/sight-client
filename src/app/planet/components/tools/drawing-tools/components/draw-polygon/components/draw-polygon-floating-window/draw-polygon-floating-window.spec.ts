...
import { DrawPolygonFloatingWindow } from './draw-polygon-floating-window';
...
describe('DrawPolygonFloatingWindow', () => {
  let component: DrawPolygonFloatingWindow;
  let fixture: ComponentFixture<DrawPolygonFloatingWindow>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [DrawPolygonFloatingWindow],
      providers: [
    ...
    fixture = TestBed.createComponent(DrawPolygonFloatingWindow);
