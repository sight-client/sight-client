...
const drawRectangleComponentProviders = (
...
describe('DrawRectangle', () => {
  describe('TestBed hygiene', () => {
    let component: DrawRectangle;
    let fixture: ComponentFixture<DrawRectangle>;

    beforeEach(async () => {
      await TestBed.configureTestingModule({
        imports: [DrawRectangle],
        providers: [
          provideZonelessChangeDetection(),
      ...
      fixture = TestBed.createComponent(DrawRectangle);
  ...
  describe('tool activation button', () => {
    let fixture: ComponentFixture<DrawRectangle>;
    let drawRectangleService: DrawRectangleService;

    beforeEach(async () => {
      await TestBed.configureTestingModule({
        imports: [DrawRectangle],
        providers: drawRectangleComponentProviders(
      ...
      drawRectangleService = TestBed.inject(DrawRectangleService);
      fixture = TestBed.createComponent(DrawRectangle);
      fixture.detectChanges();
    });
    ...
    it('left mousedown on tool button sets isActive() true', () => {
      ...
      expect(drawRectangleService.isActive()).toBe(true);
    });
  });
});
