...
import { DrawRectangleFloatingWindow } from './draw-rectangle-floating-window';
...
describe('DrawRectangleFloatingWindow', () => {
  let component: DrawRectangleFloatingWindow;
  let fixture: ComponentFixture<DrawRectangleFloatingWindow>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [DrawRectangleFloatingWindow],
      providers: [
    ...
    fixture = TestBed.createComponent(DrawRectangleFloatingWindow);
