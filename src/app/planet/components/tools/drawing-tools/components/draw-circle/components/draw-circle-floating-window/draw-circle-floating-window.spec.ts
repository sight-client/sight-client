...
import { DrawCircleFloatingWindow } from './draw-circle-floating-window';
...
describe('DrawCircleFloatingWindow', () => {
  let component: DrawCircleFloatingWindow;
  let fixture: ComponentFixture<DrawCircleFloatingWindow>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [DrawCircleFloatingWindow],
      providers: [
    ...
    fixture = TestBed.createComponent(DrawCircleFloatingWindow);
