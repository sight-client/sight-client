...
import { DrawLineFloatingWindow } from './draw-line-floating-window';
...
describe('DrawLineFloatingWindow', () => {
  let component: DrawLineFloatingWindow;
  let fixture: ComponentFixture<DrawLineFloatingWindow>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [DrawLineFloatingWindow],
      providers: [
    ...
    fixture = TestBed.createComponent(DrawLineFloatingWindow);
