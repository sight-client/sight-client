...
import { DrawMark } from './draw-mark';
...
const drawMarkComponentProviders = (
...
describe('DrawMark', () => {
  describe('TestBed hygiene', () => {
    let component: DrawMark;
    let fixture: ComponentFixture<DrawMark>;
    ...
    beforeEach(async () => {
      ...
      fixture = TestBed.createComponent(DrawMark);
  ...
  describe('tool activation button', () => {
    let fixture: ComponentFixture<DrawMark>;
    let drawMarkService: DrawMarkService;

    beforeEach(async () => {
      await TestBed.configureTestingModule({
        imports: [DrawMark],
        providers: drawMarkComponentProviders(
      ...
      drawMarkService = TestBed.inject(DrawMarkService);
      fixture = TestBed.createComponent(DrawMark);
      fixture.detectChanges();
    });
    ...
    it('left mousedown on tool button sets isActive() true', () => {
      ...
      expect(drawMarkService.isActive()).toBe(true);
    });
  });
});
