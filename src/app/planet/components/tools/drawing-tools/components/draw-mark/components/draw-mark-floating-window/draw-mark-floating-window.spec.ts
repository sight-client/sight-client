...
import { DrawMarkFloatingWindow } from './draw-mark-floating-window';
...
describe('DrawMarkFloatingWindow', () => {
  let component: DrawMarkFloatingWindow;
  let fixture: ComponentFixture<DrawMarkFloatingWindow>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [DrawMarkFloatingWindow],
      providers: [
    ...
    fixture = TestBed.createComponent(DrawMarkFloatingWindow);
