...
const drawMarkServiceProviders = (
...
describe('DrawMarkService', () => {
  describe('TestBed hygiene', () => {
    let service: DrawMarkService;
    ...
    beforeEach(() => {
      ...
      service = TestBed.inject(DrawMarkService);
    });
  ...
  describe('tool activation', () => {
    ...
    beforeEach(() => {
      ...
      TestBed.configureTestingModule({
        providers: drawMarkServiceProviders(
