...
import { EntityRubber } from './entity-rubber';
...
describe('EntityRubber', () => {
  let component: EntityRubber;
  let fixture: ComponentFixture<EntityRubber>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [EntityRubber],
      providers: [
    ...
    fixture = TestBed.createComponent(EntityRubber);
