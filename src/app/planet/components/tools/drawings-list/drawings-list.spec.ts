...
import { DrawingsList } from './drawings-list';
...
describe('DrawingsList', () => {
  let component: DrawingsList;
  let fixture: ComponentFixture<DrawingsList>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [DrawingsList],
      providers: [
    ...
    fixture = TestBed.createComponent(DrawingsList);
