...
import { CalculateRectangleFloatingWindow } from './calculate-rectangle-floating-window';
...
describe('CalculateRectangleFloatingWindow', () => {
  let component: CalculateRectangleFloatingWindow;
  let fixture: ComponentFixture<CalculateRectangleFloatingWindow>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [CalculateRectangleFloatingWindow],
      providers: [
    ...
    fixture = TestBed.createComponent(CalculateRectangleFloatingWindow);
