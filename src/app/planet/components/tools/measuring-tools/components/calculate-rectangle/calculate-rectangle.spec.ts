...
import { CalculateRectangle } from './calculate-rectangle';
...
describe('CalculateRectangle', () => {
  let component: CalculateRectangle;
  let fixture: ComponentFixture<CalculateRectangle>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [CalculateRectangle],
      providers: [
    ...
    fixture = TestBed.createComponent(CalculateRectangle);
