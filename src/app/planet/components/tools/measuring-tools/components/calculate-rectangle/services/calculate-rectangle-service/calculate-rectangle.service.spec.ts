...
function fakeToolsServiceForActivation() {
  ...
  return {
    ...
    toolsService: {
      ...
      measuringToolsLayerName: 'measureLayer',
      drawRouteLayerName: 'drawRoute',
    } as unknown as ToolsService,
  };
}

const calculateRectangleServiceProviders = (
...
describe('CalculateRectangleService', () => {
  describe('TestBed hygiene', () => {
    let service: CalculateRectangleService;
    ...
    beforeEach(() => {
      ...
      service = TestBed.inject(CalculateRectangleService);
    });
  ...
  describe('tool activation', () => {
    ...
    beforeEach(() => {
      ...
      TestBed.configureTestingModule({
        providers: calculateRectangleServiceProviders(
