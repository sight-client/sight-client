...
describe('CalculateRectangleFloatingWindowService', () => {
  let service: CalculateRectangleFloatingWindowService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(CalculateRectangleFloatingWindowService);
  });
