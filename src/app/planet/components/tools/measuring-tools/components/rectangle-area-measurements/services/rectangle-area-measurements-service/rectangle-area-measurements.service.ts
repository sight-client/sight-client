...
export class RectangleAreaMeasurementsService {
  ...
  // Еще используется в rectangle-area-measurements-floating-window.service.ts
  public readonly toolName: MeasuringToolName = 'rectangleAreaMeasurements';
  // Используется в rectangle-area-measurements.ts
