...
const calculatePolygonServiceProviders = (
...
describe('CalculatePolygonService', () => {
  describe('TestBed hygiene', () => {
    let service: CalculatePolygonService;
    ...
    beforeEach(() => {
      ...
      service = TestBed.inject(CalculatePolygonService);
    });
  ...
  describe('tool activation', () => {
    ...
    beforeEach(() => {
      ...
      TestBed.configureTestingModule({
        providers: calculatePolygonServiceProviders(
