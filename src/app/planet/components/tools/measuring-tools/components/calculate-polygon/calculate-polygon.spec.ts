...
import { CalculatePolygon } from './calculate-polygon';
...
describe('CalculatePolygon', () => {
  let component: CalculatePolygon;
  let fixture: ComponentFixture<CalculatePolygon>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [CalculatePolygon],
      providers: [
    ...
    fixture = TestBed.createComponent(CalculatePolygon);
