...
describe('CalculatePolygonFloatingWindowService', () => {
  let service: CalculatePolygonFloatingWindowService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(CalculatePolygonFloatingWindowService);
  });
