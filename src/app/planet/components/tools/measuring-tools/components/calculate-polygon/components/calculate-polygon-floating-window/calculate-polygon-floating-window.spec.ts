...
import { CalculatePolygonFloatingWindow } from './calculate-polygon-floating-window';
...
describe('CalculatePolygonFloatingWindow', () => {
  let component: CalculatePolygonFloatingWindow;
  let fixture: ComponentFixture<CalculatePolygonFloatingWindow>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [CalculatePolygonFloatingWindow],
      providers: [
    ...
    fixture = TestBed.createComponent(CalculatePolygonFloatingWindow);
