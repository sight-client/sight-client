...
import { CalculateCircleFloatingWindow } from './calculate-circle-floating-window';
...
describe('CalculateCircleFloatingWindow', () => {
  let component: CalculateCircleFloatingWindow;
  let fixture: ComponentFixture<CalculateCircleFloatingWindow>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [CalculateCircleFloatingWindow],
      providers: [
    ...
    fixture = TestBed.createComponent(CalculateCircleFloatingWindow);
