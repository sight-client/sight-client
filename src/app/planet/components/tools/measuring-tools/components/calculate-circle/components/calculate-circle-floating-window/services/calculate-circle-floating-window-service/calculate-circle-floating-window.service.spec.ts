...
describe('CalculateCircleFloatingWindowService', () => {
  let service: CalculateCircleFloatingWindowService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(CalculateCircleFloatingWindowService);
  });
