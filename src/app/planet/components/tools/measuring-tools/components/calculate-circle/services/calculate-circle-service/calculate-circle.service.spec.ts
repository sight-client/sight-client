...
const calculateCircleServiceProviders = (
...
describe('CalculateCircleService', () => {
  describe('TestBed hygiene', () => {
    let service: CalculateCircleService;
    ...
    beforeEach(() => {
      ...
      service = TestBed.inject(CalculateCircleService);
    });
  ...
  describe('tool activation', () => {
    ...
    beforeEach(() => {
      ...
      TestBed.configureTestingModule({
        providers: calculateCircleServiceProviders(
