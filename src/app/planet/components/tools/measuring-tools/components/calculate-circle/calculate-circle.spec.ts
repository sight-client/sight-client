...
import { CalculateCircle } from './calculate-circle';
...
describe('CalculateCircle', () => {
  let component: CalculateCircle;
  let fixture: ComponentFixture<CalculateCircle>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [CalculateCircle],
      providers: [
    ...
    fixture = TestBed.createComponent(CalculateCircle);
