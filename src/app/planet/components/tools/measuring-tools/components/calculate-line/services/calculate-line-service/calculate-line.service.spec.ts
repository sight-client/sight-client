...
const calculateLineServiceProviders = (
...
describe('CalculateLineService', () => {
  describe('TestBed hygiene', () => {
    let service: CalculateLineService;
    ...
    beforeEach(() => {
      ...
      service = TestBed.inject(CalculateLineService);
    });
  ...
  describe('tool activation', () => {
    ...
    beforeEach(() => {
      ...
      TestBed.configureTestingModule({
        providers: calculateLineServiceProviders(
