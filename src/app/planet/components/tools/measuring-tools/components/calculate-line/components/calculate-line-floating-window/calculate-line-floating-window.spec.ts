...
import { CalculateLineFloatingWindow } from './calculate-line-floating-window';
...
describe('CalculateLineFloatingWindow', () => {
  let component: CalculateLineFloatingWindow;
  let fixture: ComponentFixture<CalculateLineFloatingWindow>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [CalculateLineFloatingWindow],
      providers: [
    ...
    fixture = TestBed.createComponent(CalculateLineFloatingWindow);
