...
import { CircleAreaMeasurements } from './circle-area-measurements';
...
describe('CircleAreaMeasurements', () => {
  let component: CircleAreaMeasurements;
  let fixture: ComponentFixture<CircleAreaMeasurements>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [CircleAreaMeasurements],
      providers: [
    ...
    fixture = TestBed.createComponent(CircleAreaMeasurements);
