...
`],encapsulation:2})}return n})();var F=(()=>{class n{static ɵfac=function(i){return new(i||n)};static ɵmod=$E({type:n});static ɵinj=Xl({imports:[fi]})}return n})();var _=class n{constructor(){this.addListener()}cursorXExport=0;cursorYExport=0;listenerExistence=!1;addListener(){document.addEventListener(`mousemove`,t=>{this.cursorXExport=t.clientX,this.cursorYExport=t.clientY}),this.listenerExistence=!this.listenerExistence}removeListener(){document.removeEventListener(`mousemove`,t=>{this.cursorXExport=t.clientX,this.cursorYExport=t.clientY}),this.listenerExistence=!this.listenerExistence}addListenerOnce(){document.addEventListener(`mousemove`,t=>{this.cursorXExport=t.clientX,this.cursorYExport=t.clientY},{once:!0})}static ɵfac=function(e){return new(e||n)};static ɵprov=X({token:n,factory:n.ɵfac,providedIn:`root`})};var V=class n{constructor(t,e){this.$setCursorProgressSpinnerService=t;this.$cursorPositionListener=e;this.$cursorPositionListener.listenerExistence===!0&&(this.mouseX=this.$cursorPositionListener.cursorXExport+this.difX,this.mouseY=this.$cursorPositionListener.cursorYExport+this.difY)}$setCursorProgressSpinnerService;$cursorPositionListener;mouseX=0;mouseY=0;clientX=0;clientY=0;difX=15;difY=15;initialWidth=window.innerWidth;innerHeight=window.innerHeight;onMouseMove(t){this.clientX=t.clientX,this.clientY=t.clientY,this.mouseX=t.clientX+this.difX,this.mouseY=t.clientY+this.difY}onResize(t){let e=window.innerWidth,i=window.innerHeight,r=(e-this.initialWidth)/this.initialWidth,s=(i-this.innerHeight)/this.innerHeight;if(this.difX=this.difX+this.difX*r,this.difY=this.difY+this.difY*s,this.initialWidth=e,this.innerHeight=i,this.$setCursorProgressSpinnerService.isShowSpinner()){let Q=new MouseEvent(`mousemove`,{clientX:this.clientX+this.clientX*r,clientY:this.clientY+this.clientY*s});document.dispatchEvent(Q)}}static ɵfac=function(e){return new(e||n)(ji(Xh),ji(_))};static ɵcmp=HE({type:n,selectors:[[`cursor-progress-spinner`]],hostBindings:function(e,i){e&1&&Th(`mousemove`,function(s){return i.onMouseMove(s)},gv)(`resize`,function(s){return i.onResize(s)},hv)},decls:1,vars:4,consts:[[2,`position`,`fixed`,`z-index`,`1001`,`width`,`15px`,`height`,`15px`]],template:function(e,i){e&1&&mh(0,`mat-spinner`,0),e&2&&Ah(`left`,i.mouseX,`px`)(`top`,i.mouseY,`px`)},dependencies:[F,$],encapsulation:2})};export{V as CursorProgressSpinner};